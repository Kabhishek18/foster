			...
			<div class="row">
				<div class="col-md-12 col-lg-8 col-xl-8">
					<div class="checkout_form">
						...
						<div class="checkout_coupon ui_kit_button">
				            ...
				            <form class="form2" id="coupon_form" name="contact_form" action="<?=base_url()?>cart/CheckoutOrder" method="post">
								<div class="row">
									<div class="col-sm-12">
                        ...
                        <?php }?> 
					                ...
					                <div class="col-sm-12">
					                    <div class="form-group">
											...
											<input id="form_name" name="fullname" class="form-control" required="required" type="text">
										</div>
					                </div>
					                <div class="col-sm-12">
					                    <div class="form-group">
					                    	<label for="exampleInputName3">Company name (optional)</label>
											<input id="form_name3" name="company_name" class="form-control" type="text">
										</div>
					                </div>
								    <div class="col-lg-12">
					                ...
					                <div class="col-sm-12">
					                    <div class="form-group">
											...
											<input id="form_name4" name="street_1" class="form-control mb10" placeholder="House number and street name" required="required" type="text">
											<input id="form_name5" name="street_2" class="form-control" placeholder="Apartment, suite, unit etc. (optional)" type="text">
										</div>
					                </div>
					                <div class="col-sm-6">
					                    <div class="form-group">
					                    	<label for="exampleInputName4">Postcode / ZIP *</label>
											<input id="form_name6" name="zip" class="form-control" required="required" type="number">
										</div>
					                </div>
					                <div class="col-sm-6">
					                    <div class="form-group">
					                    	<label for="exampleInputName5">Town / City *</label>
											<input id="form_name7" name="town" class="form-control" required="required" type="text">
										</div>
					                </div>
					                <div class="col-sm-6">
					                    <div class="form-group">
					                    	<label for="exampleInputProvince">State/Province *</label>
											<input id="form_name8" name="state" class="form-control" required="required" type="text">
										</div>
					                </div>
					                <div class="col-sm-6">
					                    <div class="form-group">
					                    	<label for="exampleInputPhone">Phone *</label>
											<input id="form_phone" name="phone" class="form-control" required="required" type="number">
										</div>
					                </div>
					                <div class="col-sm-12">
					                    <div class="form-group">
					                ...
					                <div class="col-sm-12">
			                            <div class="form-group mb0">
			                                ...
			                                <textarea id="form_message" name="message" class="form-control required" rows="7" placeholder="Notes about your order, e.g. special notes for delivery." required="required"></textarea>
			                            </div>
					                </div>
				                </div>
				...
				<div class="col-lg-4 col-xl-4">
					...
					<div class="ui_kit_button payment_widget_btn">
						<button type="submit" class="btn dbxshad btn-lg btn-thm3 circle btn-block">Place Order</button>
					</div>
				</div>
				</form>
			</div>
