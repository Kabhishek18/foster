			...
			<div class="row">
				<div class="col-xl-6 offset-xl-3 text-center">
					<div class="breadcrumb_content">
						<h4 class="breadcrumb_title"><?=(urldecode($url))?></h4>
						<ol class="breadcrumb">
				...
				<div class="col-lg-12">
					<div class="shop_product_slider">
						...
						<div class="item">
							<div class="top_courses">
								<div class="thumb">
									<img class="img-whp" src="<?=base_url()?>foster/images/courses/t2.jpg" alt="t2.jpg">
									<div class="overlay">
						...
						<div class="item">
							<div class="top_courses">
								<div class="thumb">
									<img class="img-whp" src="<?=base_url()?>foster/images/courses/t3.jpg" alt="t3.jpg">
									<div class="overlay">
										<div class="tag">Top Seller</div>
										<div class="icon"><span class="flaticon-like"></span></div>
										<a class="tc_preview_course" href="#">Preview Course</a>
						...
						<div class="item">
							<div class="top_courses">
								<div class="thumb">
									<img class="img-whp" src="<?=base_url()?>foster/images/courses/t4.jpg" alt="t4.jpg">
									<div class="overlay">
										<div class="tag">Best Seller</div>
										<div class="icon"><span class="flaticon-like"></span></div>
										<a class="tc_preview_course" href="#">Preview Course</a>
				...
				<div class="col-md-12 col-lg-8 col-xl-9 shadow_box">
					<div class="row courses_list_heading">
						<div class="col-xl-4 p0">
							<div class="instructor_search_result style2">
								<p class="mt10 fz15"><span class="color-dark pr10"><?=($data?count($data):'0')?> </span> course results </p>
							</div>
						</div>
					...
					<div class="row courses_container">
						...
						<div class="col-lg-12 p0">
							<div class="courses_list_content">
								<div class="top_courses list">
									<h3>You have choosen a wrong category, please go back to courses page and select a proper category to see the content.
									</h3>
								</div>
							</div>
						</div>
