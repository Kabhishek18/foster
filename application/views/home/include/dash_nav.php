		...
		<div class="container-fluid">
		    ...
		    <nav>
		        ...
		        <div class="menu-toggle">
		            <img class="nav_logo_img img-fluid" src="<?=base_url()?>foster/images/header-logo.png" alt="header-logo.png">
		        ...
		        <ul class="header_user_notif pull-right dn-smd">
	                ...
	                <li class="user_setting">
						<div class="dropdown">
	                		<a class="btn dropdown-toggle" href="#" data-toggle="dropdown"><img class="rounded-circle" src="<?=base_url()?>foster/images/team/e1.png" alt="e1.png"></a>
						    <div class="dropdown-menu">
						    	<div class="user_set_header">
						    		<img class="float-left" src="<?=base_url()?>foster/images/team/e1.png" alt="e1.png">
							    	<p style="text-transform: capitalize;"><?=$users_name?><br><span class="address"><?=$users_email?></span></p>
						    	</div>
